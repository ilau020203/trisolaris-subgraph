...
// import { getOrCreateLiquidityPosition, getOrCreateTransaction } from './functions'
...
//   return event.params.to == ADDRESS_ZERO && event.params.from.toHex().toLowerCase() == event.address.toHex().toLowerCase()
// }

// export function isDirectTransfer(event: TransferEvent): boolean {
//   return event.params.to.toHex().toLowerCase() == event.address.toHex()
// }
